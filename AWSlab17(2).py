...
def encryptMessage(message, cipherKey, alphabet):
    encryptedMessage = ""
    uppercaseMessage = ""
    #o codigo tinha um bug aqui onde a mensagem era convertida para maiúsculo... nao tinha a linha .upper()
...
# Main logic
# tinha um 1 aqui no final da string que estava buggando o codigo
